...
export type IGetItemType = (key: string, defaultVal?: any) => any;
export type ISetItemType = (key: string, value: any) => void;
export type IRemoveItemType = (key: string) => void;

export interface IStorageAPI {
  get: IGetItemType;
  set: ISetItemType;
  remove: IRemoveItemType;
}
