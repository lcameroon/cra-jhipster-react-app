...
const ErrorBoundaryRoute = (props: any) => <></>;

const ErrorComp = () => {
  throw new Error('test');
};

describe.skip('error-boundary-route component', () => {
  beforeEach(() => {
  ...
  it.skip('Should render fallback component when an uncaught error is thrown from component', () => {
